...
2. **pnpm Version**: Consider updating the GitHub Actions workflow to use pnpm 10.27.0 (currently at 10.4.1) to match the local development version specified in `package.json`.
